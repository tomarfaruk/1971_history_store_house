	...
	<div class="main-container">
		...
		<div class="main-content">
			...
			<div class="oflow-hidden mb-15 mb-xs-0">
				...
				<h6 class="float-r mb-15"><b><a class="c-btn" href="audio-form.php">+ Add audios</a></b></h6>
			</div>
								...
								<div class="item">
									<div class="item-inner">
										<div class="oflow-hidden mt-15 mb-20">
												...
												<a href="<?php echo $row['audio_img']; ?>" target="_blank">
													<img src="<?php echo $row['audio_img']; ?>" alt="">
												</a>												</div>
												<div class="float-l">
													
													<h5><?php echo $row['audio_title']; ?>	</h5>
												</div>

												<div class="float-r right-text">
												<a href="<?php echo '../private/controllers/audio.php?id=' . $row['id']?>"
