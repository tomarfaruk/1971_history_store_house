	...
	<div class="main-container">
		...
		<div class="main-content">
			...
			<div class="oflow-hidden mb-15 mb-xs-0">
				...
				<h6 class="float-r mb-15"><b><a class="c-btn" href="document-form.php">+ Add Document</a></b></h6>
			</div>
								...
								<div class="item">
									<div class="item-inner">
										<div class="oflow-hidden mt-15 mb-20">
												...
												<a href="<?php echo $row['doc_img_url']; ?>" target="_blank">
													<img src="<?php echo $row['doc_img_url']; ?>" alt="">
												</a>
												</div>
												<div class="float-l">
													
													<h5><?php echo $row['doc_title']; ?>	</h5>
												</div>

												<div class="float-r right-text">
												<a href="<?php echo '../private/controllers/document.php?id=' . $row['id']?>"
                                               data-confirm="Are you sure you want to delete this item?"><i class="ion-trash-a"></i></a>
												</div><!--float-r-->
											</div>
											
											<a href="<?php echo $row['doc_file_url']; ?>" target="_blank">Click here to view PDF</a>
